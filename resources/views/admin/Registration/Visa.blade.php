    ...
    <main class="app-content">
        ...
        <div class="row ">
            <div class="col-md-10 mx-auto">
              <div class="tile">
                <h3 class="tile-title">Visa Registration form</h3>
                <div class="tile-body">
                    <form action="{{ route('registrations.Visa.id')}}" method="GET" id="idForm">
                    ...
                    <form action="{{ route('registrations.visa.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Register for Visa</button>
                        </div>
                    </form>
                </div>
            </div>
